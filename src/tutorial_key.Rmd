...
#mARI
mari_stars <- read_stars(here("data", "03_22_mari_avg.tif")) %>% 
  st_warp(crs = 4326)
```
...
Potential additional topics: Spatial Interpolation, multidate raster manipulation examples, 
